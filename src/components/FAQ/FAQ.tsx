        ...
        <>
            <section className="bg-white ">
                <div className="container px-6 py-12 mx-auto">
                    <h1 className="text-2xl font-semibold text-gray-800 desktop:text-3xl ">Frequently asked questions.</h1>

                    <div className="grid grid-cols-1 gap-8 mt-8 desktop:mt-16 tablet:grid-cols-2 xl:grid-cols-3">
                        <div>
                            <div className="inline-block p-3 text-white bg-[#FF3230] rounded-lg">
